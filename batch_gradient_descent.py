...
def batch_gradient_descent(init, learning_rate, data_train, target_train, precision):
    """
...
if __name__ == '__main__':
    ...
    precision = 0.000001
    try:
        batch_gradient_descent(p, learning_rate, data_train, target_train, precision)
    except TypeError:
