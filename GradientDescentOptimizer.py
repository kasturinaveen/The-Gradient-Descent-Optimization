...
class GradientDescentOptimizer():
    ...
    def batch_gradient_descent(self, init, learning_rate, data_train, target_train, precision):
        """
        ...
        while not converged:
            ...
            converged = bool(cost_diff < precision) # set to 0.0000000001
            if step % 20 == 0:
    ...
    def stochastic_gradient_descent(self, init, learning_rate, data_train, target_train, precision):
        """
        init: initial set of parameters
        learning_rate: learning rate for BGD to converge
        data_train: training data (predictors)
...
def main():
    ...
    try:
        cost, param = gd.stochastic_gradient_descent(p, learning_rate, data_train, target_train, precision)
    except TypeError:
